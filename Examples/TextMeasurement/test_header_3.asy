...
// Test file to visualize header_3 typography spacing
...
real spacing = 1.0 * 2.0 / 3.0 * 0.9 * 0.9 * 0.9 * 0.9 * 1.2;  // Increased by 20% from text_normal spacing
...
for (int row = 0; row < rows; ++row) {
    for (int col = 0; col < cols; ++col) {
        if (char_index < total_chars) {
            ...
            label(ch, (cell_x + spacing / 2, cell_y - spacing / 2), p=header_3.p, align=Center);
