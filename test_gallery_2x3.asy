...
// Row 0
gallery.add(red_square, 0, 0, "Red:", "Row 0, Col 0");
gallery.add(blue_square, 0, 1, "Blue:", "Row 0, Col 1");
gallery.add(green_square, 0, 2, "Green:", "Row 0, Col 2");

// Row 1
gallery.add(yellow_square, 1, 0, "Yellow:", "Row 1, Col 0");
gallery.add(orange_square, 1, 1, "Orange:", "Row 1, Col 1");
gallery.add(purple_square, 1, 2, "Purple:", "Row 1, Col 2");
